...
<section class="about-page">
    ...
    <div class="patient-content">
        ...
        <div class="patient-items">
            <div class="image-patient">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/image/patient1.png" alt="<?php bloginfo('clinic'); ?>">
            </div>
            <div class="patient-says">
                <h3> John Doe</h3> 
                <p>"Ohana Clinic provided exceptional care during my recent visit. The facilities were clean and modern, and the medical team was knowledgeable and compassionate. I felt comfortable and confident in their hands. Thank you for the excellent service!"</p>
                <div class="icon-rating">
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>             
                    <i class="fas fa-star"></i>
